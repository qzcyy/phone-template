          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              if (typeof file === 'string') {
                let _realUrl=''
                let _urlParams={}
                if(file.indexOf('&signatureUrl')>-1) {
                  _realUrl = file.substring(0, file.indexOf('&signatureUrl'))
                  _urlParams = file.substring(file.indexOf('{'), file.length)
                }
                this.setTitleUsingUrl(file);
                parameters.url = decodeURIComponent(_realUrl);
                parameters.httpHeaders=JSON.parse(_urlParams)
